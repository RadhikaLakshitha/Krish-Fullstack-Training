...
public class KafkaProducer {
    ...
    @Bean
    public ProducerFactory<String, ReservedStock> producerFactory(){
        return new DefaultKafkaProducerFactory<>(producerConfig());
    }

    @Bean
    public KafkaTemplate<String,ReservedStock> kafkaTemplate(ProducerFactory<String, ReservedStock> producerFactory){
